...
ReentrantLock:
• With tryLock(long time, TimeUnit unit), Task‑B can attempt to acquire the lock but proceed (or take alternate action) if its not available within a specified timeout. ⏱️
